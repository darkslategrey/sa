 ...
 */
Ext.define('AxAgenda.view.CalendarListPanel', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.axagenda.calendarlist',
    ...
    showEventMenu: function(el, xy) {
        ...
        if(!this.menu) {
            this.menu = Ext.create('AxAgenda.view.CalendarListMenu');
