...
Ext.define('AxAgenda.view.EventDetails', {
    extend: 'Ext.form.Panel',    
    alias: 'widget.axagenda.eventeditform',
	...
	this.dateRangeField = Ext.create('AxAgenda.view.DateRange', {	
	...
	this.finishedField = Ext.create('Ext.form.field.Checkbox', {
	...
	this.telMobileField = Ext.create('Ext.form.field.Text', {
	    itemId: this.id + '-telmobile',
	    name: 'ContactPhoneMobile',
	    fieldLabel: 'Tel mobile',
	    anchor: this.fieldAnchor
	});
	this.telPersoField = Ext.create('Ext.form.field.Text', {
	    xtype: 'textfield',
