 ...
 */
Ext.define('AxAgenda.view.DateRange', {
    extend: 'Ext.form.FieldContainer',
    alias: 'widget.axagenda.daterangefield',
    ...
    initRefs: function() {
        ...
        // me.finishedTask = me.down('#' + me.id + '-finished-task');
    ...
    getLayoutItems: function(singleLine) {
        ...
        return singleLine ? me.items.items : [[
            ...
            me.endDate, me.endTime //  me.finishedTask
        ]];
    },
    ...
    getFinishedTaskConfig: function() {
        return {
            xtype: 'checkbox',
            id: this.id + '-finished-task',
            boxLabel: this.finishedTaskText,
    ...
    setValue: function(v) {
        ...
        if(Ext.isArray(v)) {
            ...
            // me.finishedTask.setValue(!!v[eventMappings.IsFinished.name]);
        }
    },
